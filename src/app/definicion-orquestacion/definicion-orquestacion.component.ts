...
@Component({
  selector: 'app-definicion-orquestacion',
  templateUrl: './definicion-orquestacion.component.html',
  styleUrls: ['./definicion-orquestacion.component.scss']
})
export class DefinicionOrquestacionComponent implements OnInit {
