...
@Component({
  selector: 'app-prototipo-cobertura',
  templateUrl: './prototipo-cobertura.component.html',
  styleUrls: ['./prototipo-cobertura.component.scss']
})
export class PrototipoCoberturaComponent implements OnInit {
