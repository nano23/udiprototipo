...
@Component({
  selector: 'app-prototipo-orquestacion',
  templateUrl: './prototipo-orquestacion.component.html',
  styleUrls: ['./prototipo-orquestacion.component.scss']
})
export class PrototipoOrquestacionComponent implements OnInit {
