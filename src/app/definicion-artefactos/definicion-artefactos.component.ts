...
@Component({
  selector: 'app-definicion-artefactos',
  templateUrl: './definicion-artefactos.component.html',
  styleUrls: ['./definicion-artefactos.component.scss']
})
export class DefinicionArtefactosComponent implements OnInit {
