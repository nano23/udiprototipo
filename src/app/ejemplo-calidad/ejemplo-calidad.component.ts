...
@Component({
  selector: 'app-ejemplo-calidad',
  templateUrl: './ejemplo-calidad.component.html',
  styleUrls: ['./ejemplo-calidad.component.scss']
})
export class EjemploCalidadComponent implements OnInit {
