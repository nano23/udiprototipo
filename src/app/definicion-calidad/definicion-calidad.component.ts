...
@Component({
  selector: 'app-definicion-calidad',
  templateUrl: './definicion-calidad.component.html',
  styleUrls: ['./definicion-calidad.component.scss']
})
export class DefinicionCalidadComponent implements OnInit {
