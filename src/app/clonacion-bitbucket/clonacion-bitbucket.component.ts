...
@Component({
  selector: 'app-clonacion-bitbucket',
  templateUrl: './clonacion-bitbucket.component.html',
  styleUrls: ['./clonacion-bitbucket.component.scss']
})
export class ClonacionBitbucketComponent implements OnInit {
