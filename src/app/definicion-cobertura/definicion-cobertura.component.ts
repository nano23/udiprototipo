...
@Component({
  selector: 'app-definicion-cobertura',
  templateUrl: './definicion-cobertura.component.html',
  styleUrls: ['./definicion-cobertura.component.scss']
})
export class DefinicionCoberturaComponent implements OnInit {
