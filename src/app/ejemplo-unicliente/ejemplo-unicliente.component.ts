...
@Component({
  selector: 'app-ejemplo-unicliente',
  templateUrl: './ejemplo-unicliente.component.html',
  styleUrls: ['./ejemplo-unicliente.component.scss']
})
export class EjemploUniclienteComponent implements OnInit {
