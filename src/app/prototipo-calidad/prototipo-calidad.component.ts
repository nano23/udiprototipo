...
@Component({
  selector: 'app-prototipo-calidad',
  templateUrl: './prototipo-calidad.component.html',
  styleUrls: ['./prototipo-calidad.component.scss']
})
export class PrototipoCalidadComponent implements OnInit {
