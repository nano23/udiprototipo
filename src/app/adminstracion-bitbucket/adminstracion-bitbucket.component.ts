...
@Component({
  selector: 'app-adminstracion-bitbucket',
  templateUrl: './adminstracion-bitbucket.component.html',
  styleUrls: ['./adminstracion-bitbucket.component.scss']
})
export class AdminstracionBitbucketComponent implements OnInit {
