...
@Component({
  selector: 'app-integracion-jira',
  templateUrl: './integracion-jira.component.html',
  styleUrls: ['./integracion-jira.component.scss']
})
export class IntegracionJiraComponent implements OnInit {
