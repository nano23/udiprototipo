...
@Component({
  selector: 'app-prototipo-uniservidor',
  templateUrl: './prototipo-uniservidor.component.html',
  styleUrls: ['./prototipo-uniservidor.component.scss']
})
export class PrototipoUniservidorComponent implements OnInit {
