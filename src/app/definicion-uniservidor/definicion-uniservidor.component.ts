...
@Component({
  selector: 'app-definicion-uniservidor',
  templateUrl: './definicion-uniservidor.component.html',
  styleUrls: ['./definicion-uniservidor.component.scss']
})
export class DefinicionUniservidorComponent implements OnInit {
