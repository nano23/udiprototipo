...
@Component({
  selector: 'app-documentos-confluence',
  templateUrl: './documentos-confluence.component.html',
  styleUrls: ['./documentos-confluence.component.scss']
})
export class DocumentosConfluenceComponent implements OnInit {
