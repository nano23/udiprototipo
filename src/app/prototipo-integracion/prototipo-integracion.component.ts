...
@Component({
  selector: 'app-prototipo-integracion',
  templateUrl: './prototipo-integracion.component.html',
  styleUrls: ['./prototipo-integracion.component.scss']
})
export class PrototipoIntegracionComponent implements OnInit {
