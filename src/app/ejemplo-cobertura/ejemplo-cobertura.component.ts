...
@Component({
  selector: 'app-ejemplo-cobertura',
  templateUrl: './ejemplo-cobertura.component.html',
  styleUrls: ['./ejemplo-cobertura.component.scss']
})
export class EjemploCoberturaComponent implements OnInit {
