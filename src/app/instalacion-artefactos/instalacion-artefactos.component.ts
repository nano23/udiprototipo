...
@Component({
  selector: 'app-instalacion-artefactos',
  templateUrl: './instalacion-artefactos.component.html',
  styleUrls: ['./instalacion-artefactos.component.scss']
})
export class InstalacionArtefactosComponent implements OnInit {

  constructor(private utilService: UtilService,private router: Router,private activatedRoute: ActivatedRoute) {
