...
@Component({
  selector: 'app-desarrollo-servidor',
  templateUrl: './desarrollo-servidor.component.html',
  styleUrls: ['./desarrollo-servidor.component.scss']
})
export class DesarrolloServidorComponent implements OnInit {
