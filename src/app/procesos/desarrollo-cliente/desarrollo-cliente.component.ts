...
@Component({
  selector: 'app-desarrollo-cliente',
  templateUrl: './desarrollo-cliente.component.html',
  styleUrls: ['./desarrollo-cliente.component.scss']
})
export class DesarrolloClienteComponent implements OnInit {
