...
@Component({
  selector: 'app-definicion-carga',
  templateUrl: './definicion-carga.component.html',
  styleUrls: ['./definicion-carga.component.scss']
})
export class DefinicionCargaComponent implements OnInit {
