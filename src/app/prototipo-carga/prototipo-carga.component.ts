...
@Component({
  selector: 'app-prototipo-carga',
  templateUrl: './prototipo-carga.component.html',
  styleUrls: ['./prototipo-carga.component.scss']
})
export class PrototipoCargaComponent implements OnInit {
