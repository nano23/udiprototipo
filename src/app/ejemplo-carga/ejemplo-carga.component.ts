...
@Component({
  selector: 'app-ejemplo-carga',
  templateUrl: './ejemplo-carga.component.html',
  styleUrls: ['./ejemplo-carga.component.scss']
})
export class EjemploCargaComponent implements OnInit {
