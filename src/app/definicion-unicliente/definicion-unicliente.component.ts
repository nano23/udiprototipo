...
@Component({
  selector: 'app-definicion-unicliente',
  templateUrl: './definicion-unicliente.component.html',
  styleUrls: ['./definicion-unicliente.component.scss']
})
export class DefinicionUniclienteComponent implements OnInit {
