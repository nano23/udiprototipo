...
@Component({
  selector: 'app-ejemplo-integracion',
  templateUrl: './ejemplo-integracion.component.html',
  styleUrls: ['./ejemplo-integracion.component.scss']
})
export class EjemploIntegracionComponent implements OnInit {
