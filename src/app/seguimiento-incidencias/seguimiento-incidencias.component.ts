...
@Component({
  selector: 'app-seguimiento-incidencias',
  templateUrl: './seguimiento-incidencias.component.html',
  styleUrls: ['./seguimiento-incidencias.component.scss']
})
export class SeguimientoIncidenciasComponent implements OnInit {
