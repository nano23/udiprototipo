...
@Component({
  selector: 'app-definicion-integracion',
  templateUrl: './definicion-integracion.component.html',
  styleUrls: ['./definicion-integracion.component.scss']
})
export class DefinicionIntegracionComponent implements OnInit {
