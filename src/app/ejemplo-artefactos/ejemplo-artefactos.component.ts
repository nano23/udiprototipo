...
@Component({
  selector: 'app-ejemplo-artefactos',
  templateUrl: './ejemplo-artefactos.component.html',
  styleUrls: ['./ejemplo-artefactos.component.scss']
})
export class EjemploArtefactosComponent implements OnInit {
