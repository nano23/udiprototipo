...
@Component({
  selector: 'app-ejemplo-orquestacion',
  templateUrl: './ejemplo-orquestacion.component.html',
  styleUrls: ['./ejemplo-orquestacion.component.scss']
})
export class EjemploOrquestacionComponent implements OnInit {
