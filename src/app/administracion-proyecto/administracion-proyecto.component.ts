...
@Component({
  selector: 'app-administracion-proyecto',
  templateUrl: './administracion-proyecto.component.html',
  styleUrls: ['./administracion-proyecto.component.scss']
})
export class AdministracionProyectoComponent implements OnInit {
